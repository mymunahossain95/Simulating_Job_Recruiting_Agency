...
public class CareerCounselorDashboardController {
    ...
    @javafx.fxml.FXML
    public void handleTrainingRecommendationsButton(ActionEvent actionEvent) {
    ...
    @javafx.fxml.FXML
    public void handleJobMatchingButton(ActionEvent actionEvent) {
    ...
    @javafx.fxml.FXML
    public void handleBackToButtonOA(ActionEvent actionEvent) {
